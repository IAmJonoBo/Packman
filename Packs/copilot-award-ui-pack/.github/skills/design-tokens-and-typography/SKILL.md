---
name: design-tokens-and-typography
description: Define semantic tokens and a typography system; enforce use across components and screens.
---
...
- Radius: 2–4 steps
- Elevation/shadow: 3–5 steps (or none)
