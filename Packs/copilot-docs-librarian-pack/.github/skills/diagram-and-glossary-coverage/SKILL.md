---
name: diagram-and-glossary-coverage
description: Ensure docs include comprehensive Mermaid diagrams and an enforced glossary with first-use definitions and consistent linking.
---
...
- Use Mermaid for:
  ...
  - state diagrams (UI/system states)
  - architecture graphs (boundaries/modules)
- Place diagrams near the text they explain.
